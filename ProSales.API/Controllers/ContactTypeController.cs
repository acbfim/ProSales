...
{
    private readonly IContactTypeService service;
    ...
    /// </summary>
    [HttpGet("by-query")]
    public async Task<IActionResult> GetAllBrandByQuery([FromQuery] ContactTypeQuery query)
    {
    ...
    /// </summary>
    [HttpPost("create")]
    public async Task<IActionResult> postCreate(CreateContactTypeDto create)
    {
    ...
    /// </summary>
    [HttpPut("update")]
    public async Task<IActionResult> putUpdate(ContactTypeDto update)
    {
